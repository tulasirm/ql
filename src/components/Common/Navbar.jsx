...
const Navbar = ({ lr, theme }) => {
  ...
  return (
  <nav ref={navbar} className={`navbar navbar-expand-lg change navbar-black-bg ${theme === "light" ? "light" : ""}`} style={{ backgroundColor: '#111', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
      <div className="container">
        <Link className="logo" href="/">
          <img ref={lr} src={appData.lightLogo} alt="logo" style={{ filter: 'brightness(0) invert(1)' }} />
        </Link>
